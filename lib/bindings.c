/*
  Generated by ocaml-tree-sitter for gosu.
*/
...
// OCaml function
CAMLprim value octs_create_parser_gosu(value unit) {
  CAMLparam0();
  CAMLlocal1(v);
  ...
  ts_parser_set_language(parser, tree_sitter_gosu());
  CAMLreturn(v);
};
