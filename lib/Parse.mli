...
(**
    Functions for parsing gosu programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a gosu program from a string into a typed OCaml CST.
...
val string :
  ...
  (CST.start, CST.extra) Tree_sitter_run.Parsing_result.t

(** Parse a gosu program from a file into a typed OCaml CST.
